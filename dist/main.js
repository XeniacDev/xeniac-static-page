...
/* harmony import */ var _modules_loadingAnimation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/loadingAnimation */ "./src/js/modules/loadingAnimation.js");
...
/* harmony import */ var _modules_scrollMagic__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/scrollMagic */ "./src/js/modules/scrollMagic.js");
...
/***/ "./src/js/modules/loadingAnimation.js":
/*!********************************************!*\
  !*** ./src/js/modules/loadingAnimation.js ***!
  \********************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _textAnimations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./textAnimations */ "./src/js/modules/textAnimations.js");
...
Object(scrollmagic_plugin_gsap__WEBPACK_IMPORTED_MODULE_3__["ScrollMagicPluginGsap"])(scrollmagic__WEBPACK_IMPORTED_MODULE_1__, gsap__WEBPACK_IMPORTED_MODULE_2__["TweenMax"], gsap__WEBPACK_IMPORTED_MODULE_2__["TimelineMax"]);
...
var scene = function () {
  ...
  }).setTween(_textAnimations__WEBPACK_IMPORTED_MODULE_0__["default"].f.aboutTL()).addTo(controller);
  new scrollmagic__WEBPACK_IMPORTED_MODULE_1__["Scene"]({
    triggerElement: "#skills"
  }).setTween(_textAnimations__WEBPACK_IMPORTED_MODULE_0__["default"].f.skillsTL()).addTo(controller);
  new scrollmagic__WEBPACK_IMPORTED_MODULE_1__["Scene"]({
    triggerElement: "#social"
  }).setTween(_textAnimations__WEBPACK_IMPORTED_MODULE_0__["default"].f.socialTL()).addTo(controller);
}();
...
/***/ "./src/js/modules/textAnimations.js":
/*!******************************************!*\
  !*** ./src/js/modules/textAnimations.js ***!
  \******************************************/
/*! exports provided: default */
...
var textAnimations = function () {
  // default params for title animations
  var titleAnimationParams = {
    opacity: 1,
    y: 0,
    duration: 1.5,
    stagger: 0.2,
  ...
  var descriptionAnimationParams = {
    opacity: 0,
    y: 40,
    duration: 1.6,
    ease: "expo"
  ...
  var aboutText = document.querySelectorAll(".x-about-title > span");

  var aboutTL = function aboutTL() {
    return gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline().to(aboutText, _objectSpread({}, titleAnimationParams)).from(".x-about-description", _objectSpread({}, descriptionAnimationParams), "-=1.3");
  }; // skills animations


  var skillsText = document.querySelectorAll(".x-skills-title-wrapper > span");
  var xpList = document.querySelectorAll(".x-skills-xp > .x-xp");

  var skillsTL = function skillsTL() {
    return gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline().to(skillsText, _objectSpread({}, titleAnimationParams)).from(".x-skills-skill-list", _objectSpread({}, descriptionAnimationParams), "-=1.3").from(xpList, {
      opacity: 0,
      x: -50,
      duration: 1,
      stagger: 0.4,
  ...
  var socialText = document.querySelectorAll(".x-social-title > span");

  var socialTL = function socialTL() {
    return gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline().to(socialText, _objectSpread({}, titleAnimationParams));
  };
...
/* harmony default export */ __webpack_exports__["default"] = (textAnimations);
